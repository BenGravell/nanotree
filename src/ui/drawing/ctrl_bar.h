...
CtrlState DrawCtrlBar(CtrlState state, const bool trigger_tree_reset, const bool goal_reached) {
    ...
    const bool tree_should_grow_once = GuiButton((Rectangle){CTRL_BAR_COL_1_X + BUTTON_SPACING_X / 2, CTRL_BAR_ROW_7_Y, CTRL_BAR_BUTTON_WIDTH, CTRL_BAR_BUTTON_HEIGHT}, "Advance");
    state.tree_should_reset = GuiButton((Rectangle){CTRL_BAR_COL_1_X + BUTTON_SPACING_X / 2, CTRL_BAR_ROW_9_Y, CTRL_BAR_BUTTON_WIDTH, CTRL_BAR_BUTTON_HEIGHT}, "Reset");
    ...
    const int SPINNER_LABEL_TEXT_HEIGHT = TEXT_HEIGHT;
    ...
    GuiSpinner((Rectangle){CTRL_BAR_BUTTON_X_MIN, CTRL_BAR_ROW_12_Y, CTRL_BAR_WIDE_BUTTON_WIDTH, CTRL_BAR_BUTTON_HEIGHT}, NULL, &state.num_carryover_ix, 0, NUM_CARRYOVER_OPTIONS.size() - 1, false);
    GuiSetStyle(DEFAULT, TEXT_SIZE, SPINNER_LABEL_TEXT_HEIGHT);
    GuiLabelValue((Rectangle){CTRL_BAR_BUTTON_X_MIN, CTRL_BAR_ROW_14_Y, CTRL_BAR_WIDE_BUTTON_WIDTH, SPINNER_LABEL_HEIGHT}, "Carryover", TextFormat("%6d", NUM_CARRYOVER_OPTIONS[state.num_carryover_ix]));
    GuiSetStyle(DEFAULT, TEXT_SIZE, TEXT_HEIGHT);

    GuiSpinner((Rectangle){CTRL_BAR_BUTTON_X_MIN, CTRL_BAR_ROW_15_Y, CTRL_BAR_WIDE_BUTTON_WIDTH, CTRL_BAR_BUTTON_HEIGHT}, NULL, &state.num_samples_ix, 0, NUM_SAMPLES_OPTIONS.size() - 1, false);
    GuiSetStyle(DEFAULT, TEXT_SIZE, SPINNER_LABEL_TEXT_HEIGHT);
    GuiLabelValue((Rectangle){CTRL_BAR_BUTTON_X_MIN, CTRL_BAR_ROW_17_Y, CTRL_BAR_WIDE_BUTTON_WIDTH, SPINNER_LABEL_HEIGHT}, "Samples", TextFormat("%6d", NUM_SAMPLES_OPTIONS[state.num_samples_ix]));
    GuiSetStyle(DEFAULT, TEXT_SIZE, TEXT_HEIGHT);
